import svgPaths from "./svg-sxgt6bhtbm";
  ...
  return (
    <div className="h-[37.5px] relative shrink-0 w-[187.594px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-ew64yg font-['League_Spartan:Black',sans-serif] font-black leading-[37.5px] left-0 text-[#252b37] text-[30px] top-0 tracking-[-0.75px]">Fullscreen Pills</p>
      </div>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[26px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute css-ew64yg font-['Nunito:Regular',sans-serif] font-normal leading-[26px] left-0 text-[#6b7280] text-[16px] top-0">Layout plein écran avec pills horizontales interactives</p>
    </div>
  );
}
...
function Heading() {
  return (
    <div className="h-[75px] relative shrink-0 w-full" data-name="Heading 1">
      <p className="-translate-x-1/2 absolute css-ew64yg font-['League_Spartan:Black',sans-serif] font-black leading-[75px] left-[468.41px] text-[#252b37] text-[60px] text-center top-0 tracking-[-1.5px]">Maîtrise des outils numériques</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="h-[32.5px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="-translate-x-1/2 absolute css-ew64yg font-['Nunito:Regular',sans-serif] font-normal leading-[32.5px] left-[467.66px] text-[#6b7280] text-[20px] text-center top-[-0.5px]">Sélectionnez votre niveau de compétence</p>
    </div>
  );
}
...
function FullscreenPillsLayout() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="FullscreenPillsLayout">
      <p className="-translate-x-1/2 absolute css-ew64yg font-['Nunito:Medium',sans-serif] font-medium leading-[48px] left-[45px] text-[#252b37] text-[48px] text-center top-[-1px]">✨</p>
    </div>
  );
}
...
function FullscreenPillsLayout1() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="FullscreenPillsLayout">
      <p className="-translate-x-1/2 absolute css-ew64yg font-['League_Spartan:Bold',sans-serif] font-bold leading-[24px] left-[45.16px] text-[#252b37] text-[16px] text-center top-[-0.5px]">Débutant</p>
    </div>
  );
}
...
function FullscreenPillsLayout2() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="FullscreenPillsLayout">
      <p className="css-4hzbpn flex-[1_0_0] font-['Nunito:Medium',sans-serif] font-medium leading-[16px] min-h-px min-w-px relative text-[#6b7280] text-[12px] text-center">Je découvre</p>
    </div>
  );
}
...
function FullscreenPillsLayout4() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="FullscreenPillsLayout">
      <p className="-translate-x-1/2 absolute css-ew64yg font-['League_Spartan:Bold',sans-serif] font-bold leading-[24px] left-[45.22px] text-[#252b37] text-[16px] text-center top-[-0.5px]">Novice</p>
    </div>
  );
}
...
function FullscreenPillsLayout5() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="FullscreenPillsLayout">
      <p className="css-4hzbpn flex-[1_0_0] font-['Nunito:Medium',sans-serif] font-medium leading-[16px] min-h-px min-w-px relative text-[#6b7280] text-[12px] text-center">Bases acquises</p>
    </div>
  );
}
...
function FullscreenPillsLayout8() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="FullscreenPillsLayout">
      <p className="css-4hzbpn flex-[1_0_0] font-['Nunito:Medium',sans-serif] font-medium leading-[16px] min-h-px min-w-px relative text-[#6b7280] text-[12px] text-center">Autonome</p>
    </div>
  );
}
...
function FullscreenPillsLayout9() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="FullscreenPillsLayout">
      <p className="-translate-x-1/2 absolute css-ew64yg font-['Nunito:Medium',sans-serif] font-medium leading-[48px] left-[48px] text-[#252b37] text-[48px] text-center top-[-1px]">🚀</p>
    </div>
  );
}
...
function FullscreenPillsLayout10() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="FullscreenPillsLayout">
      <p className="-translate-x-1/2 absolute css-ew64yg font-['League_Spartan:Bold',sans-serif] font-bold leading-[24px] left-[48.13px] text-[16px] text-center text-white top-[-0.5px]">Avancé</p>
    </div>
  );
}
...
function FullscreenPillsLayout11() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="FullscreenPillsLayout">
      <p className="css-4hzbpn flex-[1_0_0] font-['Nunito:Medium',sans-serif] font-medium leading-[16px] min-h-px min-w-px relative text-[12px] text-[rgba(255,255,255,0.9)] text-center">{`Très à l'aise`}</p>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="bg-[#7bc4d4] h-[156px] relative rounded-[32px] shadow-[0px_16px_48px_0px_rgba(123,196,212,0.25)] shrink-0 w-[144px]" data-name="Button">
...
function FullscreenPillsLayout13() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="FullscreenPillsLayout">
      <p className="-translate-x-1/2 absolute css-ew64yg font-['League_Spartan:Bold',sans-serif] font-bold leading-[24px] left-[45.18px] text-[#252b37] text-[16px] text-center top-[-0.5px]">Expert</p>
    </div>
  );
}
...
function FullscreenPillsLayout14() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="FullscreenPillsLayout">
      <p className="css-4hzbpn flex-[1_0_0] font-['Nunito:Medium',sans-serif] font-medium leading-[16px] min-h-px min-w-px relative text-[#6b7280] text-[12px] text-center">Maîtrise totale</p>
    </div>
  );
}
...
function FullscreenPillsLayout15() {
  return (
    <div className="h-[357.5px] relative shrink-0 w-[935px]" data-name="FullscreenPillsLayout">
...
function Container6() {
  return (
    <div className="content-stretch flex h-[500px] items-center justify-center p-[2px] relative rounded-[24px] shrink-0 w-full" data-name="Container" style={{ backgroundImage: "linear-gradient(154.215deg, rgb(232, 244, 247) 0%, rgb(255, 249, 238) 100%)" }}>
...
function SandboxPositionnementComplete() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[32px] h-[991.5px] items-start left-0 pl-[368px] pr-[48px] pt-[303px] top-0 w-[1451px]" data-name="SandboxPositionnementComplete">
      <Container3 />
      <Container6 />
    </div>
  );
...
function Heading4() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute css-ew64yg font-['League_Spartan:Bold',sans-serif] font-bold leading-[21px] left-0 text-[#252b37] text-[14px] top-0">Floating Glass Modal</p>
    </div>
  );
}
...
function Heading5() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute css-ew64yg font-['League_Spartan:Bold',sans-serif] font-bold leading-[21px] left-0 text-[#55a1b4] text-[14px] top-0">Fullscreen Pills</p>
    </div>
  );
}
...
function Button10() {
  return (
    <div className="bg-[#f5f5f5] h-[45px] relative rounded-[16px] shrink-0 w-[126.219px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon8 />
        <p className="-translate-x-1/2 absolute css-ew64yg font-['Nunito:Medium',sans-serif] font-medium leading-[21px] left-[76.5px] text-[#252b37] text-[14px] text-center top-[12px]">Floating</p>
      </div>
    </div>
  );
}
...
function Button11() {
  return (
    <div className="bg-[#55a1b4] h-[45px] relative rounded-[16px] shrink-0 w-[140.844px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon9 />
        <p className="-translate-x-1/2 absolute css-ew64yg font-['Nunito:Bold',sans-serif] font-bold leading-[21px] left-[83.5px] text-[14px] text-center text-white top-[12px]">Fullscreen</p>
      </div>
    </div>
  );
}
...
function SandboxPositionnementComplete2() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[255px] items-start left-0 pb-[2px] top-[314.5px] w-[1451px]" data-name="SandboxPositionnementComplete">
