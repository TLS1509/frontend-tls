import svgPaths from "./svg-dwe7z0m3wr";
import imgContainer from "figma:asset/d03aea0303fcdddd6e269e88239a240d198bea6b.png";
...
function Container21() {
  return (
    <div className="absolute h-[22px] left-0 top-[49.8px] w-[184px]" data-name="Container">
      <Text9 />
      <Text10 />
      <Text11 />
    </div>
...
function Container17() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[71.797px] items-start left-[18px] top-[18px] w-[236px]" data-name="Container">
      <Container18 />
      <Container19 />
    </div>
  );
...
function Container1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[820.375px] items-start left-0 pt-[16px] px-[16px] top-[-119.5px] w-[304px]" data-name="Container">
      <Button />
      <Button1 />
      <Button2 />
      <Button3 />
...
function Container38() {
  return <div className="absolute bg-gradient-to-b from-[rgba(0,0,0,0)] h-[384px] left-0 to-[rgba(0,0,0,0.9)] top-0 w-[634px]" data-name="Container" />;
}

function Container40() {
  return (
    <div className="absolute bg-[#55a1b4] h-[37px] left-0 rounded-[12px] top-0 w-[195.758px]" data-name="Container">
      <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[21px] left-[16px] text-[14px] text-white top-[8px] tracking-[2px] uppercase">Étude de marché</p>
    </div>
  );
}
...
function Heading() {
  return (
    <div className="absolute h-[211.195px] left-0 top-[53px] w-[506px]" data-name="Heading 1">
      <p className="absolute font-['League_Spartan:Bold',sans-serif] font-bold leading-[70.4px] left-0 text-[64px] text-white top-[-0.5px] tracking-[-2px] w-[495px] whitespace-pre-wrap">État des lieux de la formation digitale 2025</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="absolute h-[36px] left-0 top-[276.2px] w-[506px]" data-name="Paragraph">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[36px] left-0 text-[24px] text-[rgba(255,255,255,0.9)] top-[-0.5px]">Tendances, chiffres clés et perspectives</p>
    </div>
  );
}
...
function Container39() {
  return (
    <div className="absolute h-[312.195px] left-[64px] top-[7.8px] w-[506px]" data-name="Container">
      <Container40 />
      <Heading />
      <Paragraph6 />
    </div>
...
function Paragraph7() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#6b7280] text-[14px] top-0">Par Équipe Research TLA</p>
    </div>
  );
}
...
function Paragraph8() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#6b7280] text-[14px] top-0">Publié le 15 décembre 2024</p>
    </div>
  );
}
...
function Container43() {
  return (
    <div className="h-[42px] relative shrink-0 w-[177.891px]" data-name="Container">
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p232b1d80} id="Vector" stroke="var(--stroke-0, #55A1B4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p3abdf300} id="Vector_2" stroke="var(--stroke-0, #55A1B4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M8.33333 7.5H6.66667" id="Vector_3" stroke="var(--stroke-0, #55A1B4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M13.3333 10.8333H6.66667" id="Vector_4" stroke="var(--stroke-0, #55A1B4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M13.3333 14.1667H6.66667" id="Vector_5" stroke="var(--stroke-0, #55A1B4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Text18() {
  return (
    <div className="flex-[1_0_0] h-[24px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:SemiBold',sans-serif] font-semibold leading-[24px] left-0 text-[#55a1b4] text-[16px] top-0">42 pages</p>
      </div>
    </div>
  );
}
...
function Container45() {
  return (
    <div className="h-[24px] relative shrink-0 w-[95.32px]" data-name="Container">
...
function Icon2() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d="M10 12.5V2.5" id="Vector" stroke="var(--stroke-0, #6B7280)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p3053b100} id="Vector_2" stroke="var(--stroke-0, #6B7280)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p37dcb700} id="Vector_3" stroke="var(--stroke-0, #6B7280)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Text19() {
  return (
    <div className="flex-[1_0_0] h-[21px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#6b7280] text-[14px] top-0">3421 téléchargements</p>
      </div>
    </div>
  );
}
...
function Container44() {
  return (
    <div className="h-[24px] relative shrink-0 w-[281.766px]" data-name="Container">
...
function Container42() {
  return (
    <div className="absolute content-stretch flex h-[69px] items-center justify-between left-[64px] pb-[3px] top-[48px] w-[506px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b-3 border-solid inset-0 pointer-events-none" />
      <Container43 />
      <Container44 />
    </div>
  );
...
function Heading1() {
  return (
    <div className="absolute h-[90px] left-0 top-0 w-[229px]" data-name="Heading 2">
      <p className="absolute font-['League_Spartan:Bold',sans-serif] font-bold leading-[45px] left-0 text-[#252b37] text-[30px] top-[-0.5px] w-[127px] whitespace-pre-wrap">Synthèse Exécutive</p>
    </div>
  );
}
...
function Paragraph9() {
  return (
    <div className="absolute h-[194.391px] left-0 top-[106px] w-[229px]" data-name="Paragraph">
      <p className="absolute font-['Nunito:Medium',sans-serif] font-medium leading-[32.4px] left-0 text-[#252b37] text-[18px] top-[-0.5px] w-[206px] whitespace-pre-wrap">{`Une analyse complète du marché de la formation professionnelle avec données exclusives, interviews d'experts et projections 2025-2030.`}</p>
    </div>
  );
}
...
function Paragraph10() {
  return (
    <div className="absolute h-[287.969px] left-0 top-[324.39px] w-[229px]" data-name="Paragraph">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[28.8px] left-0 text-[#252b37] text-[16px] text-justify top-[-0.5px] w-[229px] whitespace-pre-wrap">{`Le marché de la formation digitale connaît une croissance exceptionnelle de 23% en 2024. Cette expansion s'explique par l'adoption massive de nouvelles méthodologies comme EDRA, la démocratisation de l'IA générative, et l'évolution des besoins en compétences.`}</p>
    </div>
  );
}
...
function Paragraph11() {
  return (
    <div className="absolute h-[230.375px] left-0 top-[636.36px] w-[229px]" data-name="Paragraph">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[28.8px] left-0 text-[#252b37] text-[16px] text-justify top-[-0.5px] w-[229px] whitespace-pre-wrap">Les entreprises investissent désormais en moyenne 1 200€ par salarié et par an dans la formation, soit une hausse de 35% par rapport à 2023. Le ROI moyen observé est de 4.2x, ce qui confirme la pertinence de ces investissements.</p>
    </div>
  );
}
...
function Heading8() {
  return (
    <div className="h-[54px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[27px] left-0 text-[#55a1b4] text-[18px] top-0 w-[130px] whitespace-pre-wrap">📊 Chiffres Clés 2024</p>
    </div>
  );
}
...
function Icon3() {
  return (
    <div className="absolute left-0 size-[20px] top-[2px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_1177_1409)" id="Icon">
...
function Text20() {
  return (
    <div className="absolute h-[42px] left-[28px] top-0 w-[147px]" data-name="Text">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#252b37] text-[14px] top-0 w-[146px] whitespace-pre-wrap">+23% de croissance du marché</p>
    </div>
  );
}
...
function Text21() {
  return (
    <div className="absolute h-[42px] left-[28px] top-0 w-[147px]" data-name="Text">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#252b37] text-[14px] top-0 w-[116px] whitespace-pre-wrap">87% de taux de complétion moyen</p>
    </div>
  );
}
...
function Text22() {
  return (
    <div className="absolute h-[21px] left-[28px] top-0 w-[138.039px]" data-name="Text">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#252b37] text-[14px] top-0">4.2x de ROI formation</p>
    </div>
  );
}
...
function Text23() {
  return (
    <div className="absolute h-[42px] left-[28px] top-0 w-[147px]" data-name="Text">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#252b37] text-[14px] top-0 w-[121px] whitespace-pre-wrap">1 200€ investis par salarié/an</p>
    </div>
  );
}
...
function Container49() {
  return (
    <div className="absolute bg-[#e8f4f7] content-stretch flex flex-col gap-[12px] h-[292px] items-start left-0 pb-[3px] pt-[27px] px-[27px] rounded-[24px] top-[890.73px] w-[229px]" data-name="Container">
...
function Container48() {
  return (
    <div className="col-1 h-[1206.734px] justify-self-stretch relative row-1 shrink-0" data-name="Container">
      <Heading1 />
      <Paragraph9 />
      <Paragraph10 />
      <Paragraph11 />
...
function Heading9() {
  return (
    <div className="absolute h-[90px] left-0 top-0 w-[229px]" data-name="Heading 2">
      <p className="absolute font-['League_Spartan:Bold',sans-serif] font-bold leading-[45px] left-0 text-[#252b37] text-[30px] top-[-0.5px] w-[210px] whitespace-pre-wrap">Les 5 Tendances Majeures</p>
    </div>
  );
}
...
function Text24() {
  return (
    <div className="h-[30px] relative shrink-0 w-[12px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[30px] left-0 text-[20px] text-white top-[-0.5px]">1</p>
      </div>
    </div>
  );
}
...
function Container52() {
  return (
    <div className="bg-[#f8b044] relative rounded-[16px] shrink-0 size-[48px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <Text24 />
      </div>
    </div>
...
function Heading10() {
  return (
    <div className="h-[27px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[27px] left-0 text-[#252b37] text-[18px] top-0">IA Générative</p>
    </div>
  );
}
...
function Paragraph12() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#6b7280] text-[14px] top-0 w-[164px] whitespace-pre-wrap">Personnalisation à grande échelle des parcours</p>
    </div>
  );
}
...
function Container53() {
  return (
    <div className="flex-[1_0_0] h-[73px] min-h-px min-w-px relative" data-name="Container">
...
function Container51() {
  return (
    <div className="absolute content-stretch flex gap-[16px] h-[90px] items-start left-0 pb-px top-[106px] w-[229px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <Container52 />
      <Container53 />
    </div>
...
function Text25() {
  return (
    <div className="h-[30px] relative shrink-0 w-[12px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[30px] left-0 text-[20px] text-white top-[-0.5px]">2</p>
      </div>
    </div>
  );
}
...
function Heading11() {
  return (
    <div className="h-[27px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[27px] left-0 text-[#252b37] text-[18px] top-0">Micro-Learning</p>
    </div>
  );
}
...
function Paragraph13() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#6b7280] text-[14px] top-0 w-[154px] whitespace-pre-wrap">{`Formats 3-5 min pour maximiser l'engagement`}</p>
    </div>
  );
}
...
function Container54() {
  return (
    <div className="absolute content-stretch flex gap-[16px] h-[90px] items-start left-0 pb-px top-[220px] w-[229px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <Container55 />
      <Container56 />
    </div>
...
function Text26() {
  return (
    <div className="h-[30px] relative shrink-0 w-[12px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[30px] left-0 text-[20px] text-white top-[-0.5px]">3</p>
      </div>
    </div>
  );
}
...
function Heading12() {
  return (
    <div className="h-[27px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[27px] left-0 text-[#252b37] text-[18px] top-0">Gamification</p>
    </div>
  );
}
...
function Paragraph14() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#6b7280] text-[14px] top-0 w-[149px] whitespace-pre-wrap">Mécaniques de jeu pour booster la motivation</p>
    </div>
  );
}
...
function Container57() {
  return (
    <div className="absolute content-stretch flex gap-[16px] h-[90px] items-start left-0 pb-px top-[334px] w-[229px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <Container58 />
      <Container59 />
    </div>
...
function Text27() {
  return (
    <div className="h-[30px] relative shrink-0 w-[12px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[30px] left-0 text-[20px] text-white top-[-0.5px]">4</p>
      </div>
    </div>
  );
}
...
function Heading13() {
  return (
    <div className="h-[27px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[27px] left-0 text-[#252b37] text-[18px] top-0">Social Learning</p>
    </div>
  );
}
...
function Paragraph15() {
  return (
    <div className="h-[63px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#6b7280] text-[14px] top-0 w-[92px] whitespace-pre-wrap">Apprentissage collaboratif et communautés</p>
    </div>
  );
}
...
function Container62() {
  return (
    <div className="flex-[1_0_0] h-[94px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[4px] items-start relative size-full">
        <Heading13 />
        <Paragraph15 />
      </div>
...
function Container60() {
  return (
    <div className="absolute content-stretch flex gap-[16px] h-[111px] items-start left-0 pb-px top-[448px] w-[229px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <Container61 />
      <Container62 />
    </div>
...
function Text28() {
  return (
    <div className="h-[30px] relative shrink-0 w-[12px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[30px] left-0 text-[20px] text-white top-[-0.5px]">5</p>
      </div>
    </div>
  );
}
...
function Heading14() {
  return (
    <div className="h-[27px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[27px] left-0 text-[#252b37] text-[18px] top-0">Analytics Avancées</p>
    </div>
  );
}
...
function Paragraph16() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#6b7280] text-[14px] top-0 w-[158px] whitespace-pre-wrap">{`Mesure précise du ROI et de l'impact`}</p>
    </div>
  );
}
...
function Container63() {
  return (
    <div className="absolute content-stretch flex gap-[16px] h-[90px] items-start left-0 pb-px top-[583px] w-[229px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <Container64 />
      <Container65 />
    </div>
...
function Icon7() {
  return (
    <div className="absolute h-[20px] left-[24px] top-[42px] w-[11.727px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.7266 20">
        <g id="Icon">
          <path d="M5.86328 11.4658V5.60254" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.977214" />
          <path d={svgPaths.p248599c0} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.977214" />
          <path d={svgPaths.p3e47cde6} id="Vector_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.977214" />
        </g>
      </svg>
    </div>
  );
...
function Button10() {
  return (
    <div className="absolute bg-[#55a1b4] h-[104px] left-0 rounded-[16px] top-[705px] w-[229px]" data-name="Button">
      <Icon7 />
      <p className="-translate-x-1/2 absolute font-['Nunito:SemiBold',sans-serif] font-semibold leading-[24px] left-[124.84px] text-[16px] text-center text-white top-[16px] w-[122px] whitespace-pre-wrap">Télécharger le Dossier Complet (PDF)</p>
    </div>
  );
}
...
function Container50() {
  return (
    <div className="col-2 h-[1206.734px] justify-self-stretch relative row-1 shrink-0" data-name="Container">
      <Heading9 />
      <Container51 />
      <Container54 />
      <Container57 />
...
function Container47() {
  return (
    <div className="absolute gap-x-[48px] gap-y-[48px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[repeat(1,minmax(0,1fr))] h-[1206.734px] left-[64px] top-[149px] w-[506px]" data-name="Container">
      <Container48 />
      <Container50 />
    </div>
  );
...
function Container67() {
  return (
    <div className="absolute bg-[#e8f4f7] border-2 border-[#55a1b4] border-solid h-[41px] left-0 rounded-[9999px] top-[32px] w-[91.227px]" data-name="Container">
      <p className="absolute font-['Nunito:SemiBold',sans-serif] font-semibold leading-[21px] left-[16px] text-[#55a1b4] text-[14px] top-[8px]">#Marché</p>
    </div>
  );
}
...
function Container68() {
  return (
    <div className="absolute bg-[#e8f4f7] border-2 border-[#55a1b4] border-solid h-[41px] left-[103.23px] rounded-[9999px] top-[32px] w-[112px]" data-name="Container">
      <p className="absolute font-['Nunito:SemiBold',sans-serif] font-semibold leading-[21px] left-[16px] text-[#55a1b4] text-[14px] top-[8px]">#Tendances</p>
    </div>
  );
}
...
function Container69() {
  return (
    <div className="absolute bg-[#e8f4f7] border-2 border-[#55a1b4] border-solid h-[41px] left-[227.23px] rounded-[9999px] top-[32px] w-[103.82px]" data-name="Container">
      <p className="absolute font-['Nunito:SemiBold',sans-serif] font-semibold leading-[21px] left-[16px] text-[#55a1b4] text-[14px] top-[8px]">#Analytics</p>
    </div>
  );
}
...
function Container66() {
  return (
    <div className="absolute border-[rgba(0,0,0,0.1)] border-solid border-t-2 h-[75px] left-[64px] top-[1403.73px] w-[506px]" data-name="Container">
      <Container67 />
      <Container68 />
      <Container69 />
    </div>
...
function Container41() {
  return (
    <div className="h-[1526.734px] relative shrink-0 w-full" data-name="Container">
      <Container42 />
      <Container47 />
      <Container66 />
    </div>
...
function Container36() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[1910.734px] items-start relative shrink-0 w-full" data-name="Container">
      <Container37 />
      <Container41 />
    </div>
  );
...
function Heading15() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="absolute font-['League_Spartan:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#252b37] text-[16px] top-[-0.5px]">Magazine 2 Col</p>
    </div>
  );
}
...
function Container72() {
  return (
    <div className="h-[42px] relative shrink-0 w-[152.555px]" data-name="Container">
