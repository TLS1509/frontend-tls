import svgPaths from "./svg-azxnohwwt7";
  ...
  return (
    <div className="h-[45px] relative shrink-0 w-[247.82px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-ew64yg font-['League_Spartan:Black',sans-serif] font-black leading-[45px] left-0 text-[#252b37] text-[30px] top-[-0.5px]">Progressive Cards</p>
      </div>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute css-ew64yg font-['Nunito:Regular',sans-serif] font-normal leading-[24px] left-0 text-[#6b7280] text-[16px] top-0">Navigation question par question avec auto-avancement et progression</p>
    </div>
  );
}
...
function Container1() {
  return <div className="bg-[#10b981] opacity-59 rounded-[9999px] shrink-0 size-[8px]" data-name="Container" />;
}
...
function Text1() {
  return (
    <div className="h-[21px] relative shrink-0 w-[88.281px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-4hzbpn font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#6b7280] text-[14px] top-0 w-[89px]">Question 1 / 3</p>
      </div>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="h-[21px] relative shrink-0 w-[30.039px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-4hzbpn font-['Nunito:Bold',sans-serif] font-bold leading-[21px] left-0 text-[#55a1b4] text-[14px] top-0 w-[31px]">33%</p>
      </div>
    </div>
  );
}
...
function ProgressiveCardsLayout() {
  return (
    <div className="h-[45px] relative shrink-0 w-full" data-name="ProgressiveCardsLayout">
      <p className="absolute css-ew64yg font-['League_Spartan:Bold',sans-serif] font-bold leading-[45px] left-0 text-[#252b37] text-[30px] top-[-0.5px]">Maîtrise des outils numériques</p>
    </div>
  );
}
...
function ProgressiveCardsLayout1() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="ProgressiveCardsLayout">
      <p className="absolute css-ew64yg font-['Nunito:Regular',sans-serif] font-normal leading-[24px] left-0 text-[#6b7280] text-[16px] top-0">Comment évaluez-vous votre niveau actuel ?</p>
    </div>
  );
}
...
function ProgressiveCardsLayout2() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="ProgressiveCardsLayout">
      <p className="-translate-x-1/2 absolute css-ew64yg font-['Nunito:Regular',sans-serif] font-normal leading-[48px] left-[57.2px] text-[#252b37] text-[48px] text-center top-[-1px]">✨</p>
    </div>
  );
}
...
function ProgressiveCardsLayout3() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="ProgressiveCardsLayout">
      <p className="-translate-x-1/2 absolute css-ew64yg font-['League_Spartan:Bold',sans-serif] font-bold leading-[21px] left-[57.41px] text-[#252b37] text-[14px] text-center top-0">Débutant</p>
    </div>
  );
}
...
function ProgressiveCardsLayout5() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="ProgressiveCardsLayout">
      <p className="-translate-x-1/2 absolute css-ew64yg font-['League_Spartan:Bold',sans-serif] font-bold leading-[21px] left-[57.39px] text-[#f59e0b] text-[14px] text-center top-0">Novice</p>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="absolute bg-[rgba(245,158,11,0.13)] content-stretch flex flex-col gap-[12px] h-[133px] items-start left-[182.4px] pb-[2px] pt-[26px] px-[26px] rounded-[16px] top-0 w-[166.398px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-2 border-[#f59e0b] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_8px_24px_0px_rgba(245,158,11,0.19)]" />
...
function ProgressiveCardsLayout7() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="ProgressiveCardsLayout">
      <p className="-translate-x-1/2 absolute css-ew64yg font-['League_Spartan:Bold',sans-serif] font-bold leading-[21px] left-[57.27px] text-[#252b37] text-[14px] text-center top-0">Intermédiaire</p>
    </div>
  );
}
...
function ProgressiveCardsLayout9() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="ProgressiveCardsLayout">
      <p className="-translate-x-1/2 absolute css-ew64yg font-['League_Spartan:Bold',sans-serif] font-bold leading-[21px] left-[57.57px] text-[#252b37] text-[14px] text-center top-0">Avancé</p>
    </div>
  );
}
...
function ProgressiveCardsLayout11() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="ProgressiveCardsLayout">
      <p className="-translate-x-1/2 absolute css-ew64yg font-['League_Spartan:Bold',sans-serif] font-bold leading-[21px] left-[57.3px] text-[#252b37] text-[14px] text-center top-0">Expert</p>
    </div>
  );
}
...
function Button5() {
  return (
    <div className="absolute h-[56px] left-[750.03px] rounded-[16px] top-[415px] w-[145.969px]" data-name="Button" style={{ backgroundImage: "linear-gradient(159.011deg, rgb(85, 161, 180) 0%, rgb(74, 143, 161) 100%)" }}>
      <p className="-translate-x-1/2 absolute css-ew64yg font-['Nunito:Bold',sans-serif] font-bold leading-[24px] left-[60px] text-[16px] text-center text-white top-[16px]">Suivant</p>
      <Icon1 />
    </div>
  );
}
...
function Container10() {
  return (
    <div className="content-stretch flex h-[571px] items-center justify-center p-[2px] relative rounded-[24px] shrink-0 w-full" data-name="Container" style={{ backgroundImage: "linear-gradient(151.115deg, rgb(232, 244, 247) 0%, rgb(255, 249, 238) 100%)" }}>
...
function SandboxPositionnementComplete() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[32px] h-[1068px] items-start left-0 pl-[368px] pr-[48px] pt-[303px] top-0 w-[1451px]" data-name="SandboxPositionnementComplete">
      <Container3 />
      <Container10 />
    </div>
  );
...
function Heading3() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute css-ew64yg font-['League_Spartan:Bold',sans-serif] font-bold leading-[21px] left-0 text-[#55a1b4] text-[14px] top-0">Progressive Cards</p>
    </div>
  );
}
...
function Button10() {
  return (
    <div className="bg-[#55a1b4] h-[45px] relative rounded-[16px] shrink-0 w-[149.914px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon8 />
        <p className="-translate-x-1/2 absolute css-ew64yg font-['Nunito:Bold',sans-serif] font-bold leading-[21px] left-[88px] text-[14px] text-center text-white top-[12px]">Progressive</p>
      </div>
    </div>
  );
}
...
function SandboxPositionnementComplete2() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[255px] items-start left-0 pb-[2px] top-0 w-[1451px]" data-name="SandboxPositionnementComplete">
