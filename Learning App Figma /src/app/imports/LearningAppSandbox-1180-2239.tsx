import svgPaths from "./svg-e81y631xpi";
import imgContainer from "figma:asset/9e7c19453c8f5dd36fe888a49517ca4de15f56c5.png";
...
function Paragraph() {
  return (
    <div className="absolute h-[33.594px] left-0 top-[25px] w-[201px]" data-name="Paragraph">
...
function Container6() {
  return (
    <div className="absolute h-[22px] left-0 top-[66.59px] w-[201px]" data-name="Container">
      <Text />
      <Text1 />
      <Text2 />
    </div>
...
function Container2() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[88.594px] items-start left-[17px] top-[17px] w-[253px]" data-name="Container">
      <Container3 />
      <Container4 />
    </div>
  );
...
function Container11() {
  return (
    <div className="absolute h-[48px] left-0 top-[49.8px] w-[201px]" data-name="Container">
      <Text3 />
      <Text4 />
      <Text5 />
    </div>
...
function Container7() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[97.797px] items-start left-[17px] top-[17px] w-[253px]" data-name="Container">
      <Container8 />
      <Container9 />
    </div>
  );
...
function Container16() {
  return (
    <div className="absolute h-[48px] left-0 top-[66.59px] w-[201px]" data-name="Container">
      <Text6 />
      <Text7 />
      <Text8 />
    </div>
...
function Container12() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[114.594px] items-start left-[17px] top-[17px] w-[253px]" data-name="Container">
      <Container13 />
      <Container14 />
    </div>
  );
...
function Text14() {
  return (
    <div className="absolute h-[22px] left-[130.37px] rounded-[4px] top-0 w-[68.219px]" data-name="Text">
      <p className="absolute font-['Nunito:Medium',sans-serif] font-medium leading-[18px] left-[8px] text-[#f8b044] text-[12px] top-[2px]">Summary</p>
    </div>
  );
}
...
function Container46() {
  return (
    <div className="absolute h-[22px] left-0 top-[49.8px] w-[199px]" data-name="Container">
      <Text24 />
      <Text25 />
      <Text26 />
    </div>
...
function Container42() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[71.797px] items-start left-[18px] top-[18px] w-[251px]" data-name="Container">
      <Container43 />
      <Container44 />
    </div>
  );
...
function Button8() {
  return (
    <div className="bg-[rgba(255,255,255,0.7)] h-[107.797px] relative rounded-[16px] shrink-0 w-full" data-name="Button">
...
function Container1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[1415.359px] items-start left-0 pt-[16px] px-[16px] top-[-714.5px] w-[319px]" data-name="Container">
      <Button />
      <Button1 />
      <Button2 />
      <Button3 />
...
function Button12() {
  return (
    <div className="absolute bg-[#eef6f8] border border-[rgba(0,0,0,0.1)] border-solid h-[32px] left-[57.83px] rounded-[12px] top-0 w-[73px]" data-name="Button">
...
function Container57() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.7)] content-stretch flex flex-col h-[65px] items-start left-0 pb-px pt-[16px] px-[16px] top-0 w-[319px]" data-name="Container">
...
function Button15() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.7)] border-2 border-[rgba(0,0,0,0.1)] border-solid h-[41px] left-[32px] rounded-[12px] top-[32px] w-[105.102px]" data-name="Button">
      <Icon1 />
      <p className="-translate-x-1/2 absolute font-['Nunito:SemiBold',sans-serif] font-semibold leading-[21px] left-[63px] text-[#252b37] text-[14px] text-center top-[8px]">Fermer</p>
    </div>
  );
}

function Container63() {
  return <div className="absolute h-[1530.172px] left-0 top-0 w-[278.797px]" data-name="Container" />;
}

function Icon2() {
  return (
    <div className="absolute left-0 size-[24px] top-[6px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.pcedbe00} id="Vector" stroke="var(--stroke-0, #55A1B4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p33b6ac00} id="Vector_2" stroke="var(--stroke-0, #55A1B4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Heading1() {
  return (
    <div className="h-[36px] relative shrink-0 w-full" data-name="Heading 2">
      <Icon2 />
      <p className="absolute font-['League_Spartan:Bold',sans-serif] font-bold leading-[36px] left-[32px] text-[#252b37] text-[24px] top-[-0.5px]">Éditorial</p>
    </div>
  );
}
...
function Paragraph11() {
  return (
    <div className="h-[163.172px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Nunito:Italic',sans-serif] font-normal italic leading-[27.2px] left-0 text-[#6b7280] text-[16px] top-[-0.5px] w-[373px] whitespace-pre-wrap">{`L'intelligence artificielle transforme radicalement le paysage de la formation professionnelle. Ce numéro explore comment les organisations peuvent tirer parti de l'IA pour personnaliser l'apprentissage, automatiser les tâches répétitives et offrir des expériences pédagogiques inédites.`}</p>
    </div>
  );
}
...
function Paragraph12() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#6b7280] text-[14px] top-0">— Dr. Sophie Laurent, Rédactrice en chef</p>
    </div>
  );
}
...
function Container65() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.7)] content-stretch flex flex-col gap-[16px] h-[304.172px] items-start left-0 pb-[2px] pt-[26px] px-[26px] rounded-[16px] top-0 w-[434.203px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <Heading1 />
      <Paragraph11 />
      <Paragraph12 />
    </div>
...
function Icon3() {
  return (
    <div className="absolute left-0 size-[24px] top-[6px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d="M3 5H3.01" id="Vector" stroke="var(--stroke-0, #ED843A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M3 12H3.01" id="Vector_2" stroke="var(--stroke-0, #ED843A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M3 19H3.01" id="Vector_3" stroke="var(--stroke-0, #ED843A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M8 5H21" id="Vector_4" stroke="var(--stroke-0, #ED843A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M8 12H21" id="Vector_5" stroke="var(--stroke-0, #ED843A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M8 19H21" id="Vector_6" stroke="var(--stroke-0, #ED843A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Heading13() {
  return (
    <div className="absolute h-[36px] left-0 top-[336.17px] w-[434.203px]" data-name="Heading 2">
      <Icon3 />
      <p className="absolute font-['League_Spartan:Bold',sans-serif] font-bold leading-[36px] left-[32px] text-[#252b37] text-[24px] top-[-0.5px]">Sommaire</p>
    </div>
  );
}
...
function Text33() {
  return (
    <div className="h-[30px] relative shrink-0 w-[18.422px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['League_Spartan:Bold',sans-serif] font-bold leading-[30px] left-0 text-[20px] text-white top-[-0.5px]">01</p>
      </div>
    </div>
  );
}
...
function Container69() {
  return (
    <div className="bg-[#252b37] relative rounded-[16px] shrink-0 size-[64px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <Text33 />
      </div>
    </div>
...
function Text34() {
  return (
    <div className="bg-[#fff9ee] h-[26px] relative rounded-[4px] shrink-0 w-[74.742px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[18px] left-[8px] text-[#f8b044] text-[12px] top-[4px]">Innovation</p>
      </div>
    </div>
  );
}
...
function Text35() {
  return (
    <div className="h-[18px] relative shrink-0 w-[69.844px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[18px] left-0 text-[#6b7280] text-[12px] top-0">Pages 04-12</p>
      </div>
    </div>
  );
}
...
function Container71() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[26px] items-center left-0 top-0 w-[302.203px]" data-name="Container">
      <Text34 />
      <Text35 />
    </div>
  );
...
function Heading14() {
  return (
    <div className="absolute h-[60px] left-0 top-[34px] w-[302.203px]" data-name="Heading 3">
      <p className="absolute font-['League_Spartan:Bold',sans-serif] font-bold leading-[30px] left-0 text-[#252b37] text-[20px] top-[-0.5px] w-[232px] whitespace-pre-wrap">IA Générative : Révolution Pédagogique</p>
    </div>
  );
}
...
function Paragraph13() {
  return (
    <div className="absolute h-[42px] left-0 top-[102px] w-[302.203px]" data-name="Paragraph">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#6b7280] text-[14px] top-0 w-[298px] whitespace-pre-wrap">Comment ChatGPT et les LLMs transforment la création de contenus pédagogiques.</p>
    </div>
  );
}
...
function Text36() {
  return (
    <div className="h-[18px] relative shrink-0 w-[88.398px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[18px] left-0 text-[#6b7280] text-[12px] top-0">Par Marc Dubois</p>
      </div>
    </div>
  );
}
...
function Icon4() {
  return (
    <div className="absolute left-0 size-[12px] top-[3px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g clipPath="url(#clip0_1177_837)" id="Icon">
          <path d="M6 3V6L8 7" id="Vector" stroke="var(--stroke-0, #6B7280)" strokeLinecap="round" strokeLinejoin="round" />
          <path d={svgPaths.p3e7757b0} id="Vector_2" stroke="var(--stroke-0, #6B7280)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        <defs>
...
function Text38() {
  return (
    <div className="h-[18px] relative shrink-0 w-[53.375px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon4 />
        <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[18px] left-[16px] text-[#6b7280] text-[12px] top-0">15 min</p>
      </div>
    </div>
  );
}
...
function Container72() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[24px] items-center left-0 top-[156px] w-[302.203px]" data-name="Container">
      <Text36 />
      <Text37 />
      <Text38 />
    </div>
...
function Container67() {
  return (
    <div className="bg-[rgba(255,255,255,0.7)] h-[232px] relative rounded-[16px] shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[16px]" />
...
function Text39() {
  return (
    <div className="h-[30px] relative shrink-0 w-[23.258px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['League_Spartan:Bold',sans-serif] font-bold leading-[30px] left-0 text-[20px] text-white top-[-0.5px]">02</p>
      </div>
    </div>
  );
}
...
function Text40() {
  return (
    <div className="bg-[#fff9ee] h-[26px] relative rounded-[4px] shrink-0 w-[83.133px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[18px] left-[8px] text-[#f8b044] text-[12px] top-[4px]">Technologie</p>
      </div>
    </div>
  );
}
...
function Text41() {
  return (
    <div className="h-[18px] relative shrink-0 w-[69.844px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[18px] left-0 text-[#6b7280] text-[12px] top-0">Pages 14-22</p>
      </div>
    </div>
  );
}
...
function Heading15() {
  return (
    <div className="absolute h-[30px] left-0 top-[34px] w-[302.203px]" data-name="Heading 3">
      <p className="absolute font-['League_Spartan:Bold',sans-serif] font-bold leading-[30px] left-0 text-[#252b37] text-[20px] top-[-0.5px]">Tuteurs Virtuels Intelligents</p>
    </div>
  );
}
...
function Paragraph14() {
  return (
    <div className="absolute h-[42px] left-0 top-[72px] w-[302.203px]" data-name="Paragraph">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#6b7280] text-[14px] top-0 w-[301px] whitespace-pre-wrap">Les chatbots pédagogiques nouvelle génération qui accompagnent 24/7.</p>
    </div>
  );
}
...
function Text42() {
  return (
    <div className="h-[18px] relative shrink-0 w-[90.609px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[18px] left-0 text-[#6b7280] text-[12px] top-0">Par Claire Martin</p>
      </div>
    </div>
  );
}
...
function Text44() {
  return (
    <div className="h-[18px] relative shrink-0 w-[53.375px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon5 />
        <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[18px] left-[16px] text-[#6b7280] text-[12px] top-0">12 min</p>
      </div>
    </div>
  );
}
...
function Container78() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[24px] items-center left-0 top-[126px] w-[302.203px]" data-name="Container">
      <Text42 />
      <Text43 />
      <Text44 />
    </div>
...
function Container76() {
  return (
    <div className="flex-[1_0_0] h-[150px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container77 />
        <Heading15 />
        <Paragraph14 />
...
function Container74() {
  return (
    <div className="content-stretch flex gap-[16px] h-[150px] items-start relative shrink-0 w-full" data-name="Container">
      <Container75 />
      <Container76 />
    </div>
  );
...
function Container73() {
  return (
    <div className="bg-[rgba(255,255,255,0.7)] h-[202px] relative rounded-[16px] shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <div className="content-stretch flex flex-col items-start pb-[2px] pt-[26px] px-[26px] relative size-full">
        <Container74 />
      </div>
...
function Text45() {
  return (
    <div className="h-[30px] relative shrink-0 w-[22.625px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['League_Spartan:Bold',sans-serif] font-bold leading-[30px] left-0 text-[20px] text-white top-[-0.5px]">03</p>
      </div>
    </div>
  );
}
...
function Text46() {
  return (
    <div className="bg-[#fff9ee] h-[26px] relative rounded-[4px] shrink-0 w-[68.023px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[18px] left-[8px] text-[#f8b044] text-[12px] top-[4px]">Analytics</p>
      </div>
    </div>
  );
}
...
function Text47() {
  return (
    <div className="h-[18px] relative shrink-0 w-[69.844px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[18px] left-0 text-[#6b7280] text-[12px] top-0">Pages 24-30</p>
      </div>
    </div>
  );
}
...
function Heading16() {
  return (
    <div className="absolute h-[30px] left-0 top-[34px] w-[302.203px]" data-name="Heading 3">
      <p className="absolute font-['League_Spartan:Bold',sans-serif] font-bold leading-[30px] left-0 text-[#252b37] text-[20px] top-[-0.5px]">Analyse Prédictive de la Réussite</p>
    </div>
  );
}
...
function Paragraph15() {
  return (
    <div className="absolute h-[42px] left-0 top-[72px] w-[302.203px]" data-name="Paragraph">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#6b7280] text-[14px] top-0 w-[254px] whitespace-pre-wrap">{`Anticiper les difficultés avant qu'elles ne surviennent grâce au machine learning.`}</p>
    </div>
  );
}
...
function Text48() {
  return (
    <div className="h-[18px] relative shrink-0 w-[110.742px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[18px] left-0 text-[#6b7280] text-[12px] top-0">Par Thomas Bernard</p>
      </div>
    </div>
  );
}
...
function Text50() {
  return (
    <div className="h-[18px] relative shrink-0 w-[53.375px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon6 />
        <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[18px] left-[16px] text-[#6b7280] text-[12px] top-0">10 min</p>
      </div>
    </div>
  );
}
...
function Text51() {
  return (
    <div className="h-[30px] relative shrink-0 w-[22.391px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['League_Spartan:Bold',sans-serif] font-bold leading-[30px] left-0 text-[20px] text-white top-[-0.5px]">04</p>
      </div>
    </div>
  );
}
...
function Text52() {
  return (
    <div className="bg-[#fff9ee] h-[26px] relative rounded-[4px] shrink-0 w-[74.766px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[18px] left-[8px] text-[#f8b044] text-[12px] top-[4px]">Pédagogie</p>
      </div>
    </div>
  );
}
...
function Text53() {
  return (
    <div className="h-[18px] relative shrink-0 w-[69.844px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[18px] left-0 text-[#6b7280] text-[12px] top-0">Pages 32-38</p>
      </div>
    </div>
  );
}
...
function Heading17() {
  return (
    <div className="absolute h-[30px] left-0 top-[34px] w-[302.203px]" data-name="Heading 3">
      <p className="absolute font-['League_Spartan:Bold',sans-serif] font-bold leading-[30px] left-0 text-[#252b37] text-[20px] top-[-0.5px]">Micro-Learning Adaptatif par IA</p>
    </div>
  );
}
...
function Paragraph16() {
  return (
    <div className="absolute h-[42px] left-0 top-[72px] w-[302.203px]" data-name="Paragraph">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#6b7280] text-[14px] top-0 w-[302px] whitespace-pre-wrap">{`Des pilules de formation qui s'ajustent en temps réel au niveau de l'apprenant.`}</p>
    </div>
  );
}
...
function Text54() {
  return (
    <div className="h-[18px] relative shrink-0 w-[82.43px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[18px] left-0 text-[#6b7280] text-[12px] top-0">Par Laura Chen</p>
      </div>
    </div>
  );
}
...
function Text56() {
  return (
    <div className="h-[18px] relative shrink-0 w-[53.375px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon7 />
        <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[18px] left-[16px] text-[#6b7280] text-[12px] top-0">11 min</p>
      </div>
    </div>
  );
}
...
function Text57() {
  return (
    <div className="h-[30px] relative shrink-0 w-[22.664px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['League_Spartan:Bold',sans-serif] font-bold leading-[30px] left-0 text-[20px] text-white top-[-0.5px]">05</p>
      </div>
    </div>
  );
}
...
function Text58() {
  return (
    <div className="bg-[#fff9ee] h-[26px] relative rounded-[4px] shrink-0 w-[58.602px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[18px] left-[8px] text-[#f8b044] text-[12px] top-[4px]">Éthique</p>
      </div>
    </div>
  );
}
...
function Text59() {
  return (
    <div className="h-[18px] relative shrink-0 w-[69.844px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[18px] left-0 text-[#6b7280] text-[12px] top-0">Pages 40-48</p>
      </div>
    </div>
  );
}
...
function Heading18() {
  return (
    <div className="absolute h-[60px] left-0 top-[34px] w-[302.203px]" data-name="Heading 3">
      <p className="absolute font-['League_Spartan:Bold',sans-serif] font-bold leading-[30px] left-0 text-[#252b37] text-[20px] top-[-0.5px] w-[223px] whitespace-pre-wrap">{`Éthique et Biais de l'IA en Formation`}</p>
    </div>
  );
}
...
function Paragraph17() {
  return (
    <div className="absolute h-[42px] left-0 top-[102px] w-[302.203px]" data-name="Paragraph">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#6b7280] text-[14px] top-0 w-[263px] whitespace-pre-wrap">{`Les enjeux éthiques et les risques de biais algorithmiques dans l'apprentissage.`}</p>
    </div>
  );
}
...
function Text60() {
  return (
    <div className="h-[18px] relative shrink-0 w-[110.867px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[18px] left-0 text-[#6b7280] text-[12px] top-0">Par Dr. Marie Dubois</p>
      </div>
    </div>
  );
}
...
function Text62() {
  return (
    <div className="h-[18px] relative shrink-0 w-[53.375px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon8 />
        <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[18px] left-[16px] text-[#6b7280] text-[12px] top-0">14 min</p>
      </div>
    </div>
  );
}
...
function Container66() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[1134px] items-start left-0 top-[396.17px] w-[434.203px]" data-name="Container">
      <Container67 />
      <Container73 />
      <Container79 />
      <Container85 />
...
function Container64() {
  return (
    <div className="absolute h-[1530.172px] left-[310.8px] top-0 w-[434.203px]" data-name="Container">
      <Container65 />
      <Heading13 />
      <Container66 />
    </div>
...
function Container62() {
  return (
    <div className="absolute h-[1530.172px] left-[32px] top-[105px] w-[745px]" data-name="Container">
      <Container63 />
      <Container64 />
    </div>
  );
...
function Container61() {
  return (
    <div className="absolute bg-white h-[1667.172px] left-0 top-[-968px] w-[809px]" data-name="Container">
      <Button15 />
      <Container62 />
    </div>
  );
...
function Container99() {
  return <div className="absolute bg-gradient-to-t from-[rgba(0,0,0,0.8)] h-[600px] left-0 to-1/2 to-[rgba(0,0,0,0)] top-0 w-[274.797px]" data-name="Container" />;
}

function Container100() {
  return (
    <div className="absolute bg-[#55a1b4] h-[40px] left-[24px] rounded-[16px] shadow-[0px_4px_12px_0px_rgba(0,0,0,0.3)] top-[24px] w-[114.156px]" data-name="Container">
      <p className="absolute font-['Nunito:Bold',sans-serif] font-bold leading-[21px] left-[16px] text-[14px] text-white top-[10px]">Janvier 2025</p>
    </div>
  );
}
...
function Heading() {
  return (
    <div className="absolute h-[43.195px] left-0 top-0 w-[210.797px]" data-name="Heading 1">
      <p className="absolute font-['League_Spartan:Bold',sans-serif] font-bold leading-[43.2px] left-0 text-[36px] text-white top-0">Le Mag</p>
    </div>
  );
}
...
function Paragraph18() {
  return (
    <div className="absolute h-[90px] left-0 top-[55.2px] w-[210.797px]" data-name="Paragraph">
      <p className="absolute font-['Nunito:Regular',sans-serif] font-normal leading-[30px] left-0 text-[20px] text-[rgba(255,255,255,0.95)] top-[-0.5px] w-[120px] whitespace-pre-wrap">{`L'Intelligence Artificielle en Formation`}</p>
    </div>
  );
}
...
function Button16() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.2)] border border-[rgba(255,255,255,0.3)] border-solid h-[39px] left-0 rounded-[12px] top-[161.2px] w-[166px]" data-name="Button">
      <Icon9 />
      <p className="-translate-x-1/2 absolute font-['Nunito:Bold',sans-serif] font-bold leading-[21px] left-[94px] text-[14px] text-center text-white top-[8px]">Télécharger PDF</p>
    </div>
  );
}
...
function Container101() {
  return (
    <div className="absolute h-[200.195px] left-[32px] top-[367.8px] w-[210.797px]" data-name="Container">
      <Heading />
      <Paragraph18 />
      <Button16 />
    </div>
...
function Container97() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0)] h-[604px] left-[32px] rounded-[24px] top-[63.17px] w-[278.797px]" data-name="Container">
      <div className="content-stretch flex flex-col items-start overflow-clip p-[2px] relative rounded-[inherit] size-full">
        <Container98 />
      </div>
      <div aria-hidden="true" className="absolute border-2 border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[24px] shadow-[0px_8px_32px_0px_rgba(0,0,0,0.15)]" />
    </div>
  );
}
...
function Container60() {
  return (
    <div className="absolute h-[699px] left-0 overflow-clip top-0 w-[809px]" data-name="Container">
      <Container61 />
      <Container97 />
    </div>
  );
...
function Heading19() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="absolute font-['League_Spartan:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#252b37] text-[16px] top-[-0.5px]">Le Mag - Cover Sommaire</p>
    </div>
  );
}
...
function Container104() {
  return (
    <div className="h-[42px] relative shrink-0 w-[226.211px]" data-name="Container">
...
function Container102() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.7)] content-stretch flex flex-col h-[67px] items-start left-0 pb-px pt-[12px] px-[24px] top-0 w-[809px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <Container103 />
    </div>
  );
...
function Container59() {
  return (
    <div className="absolute h-[699px] left-[320px] overflow-clip top-[64px] w-[809px]" data-name="Container">
      <Container60 />
      <Container102 />
    </div>
  );
...
function T() {
  return (
    <div className="absolute bg-white h-[763px] left-0 top-0 w-[1129px]" data-name="T0">
      <Container />
      <Container59 />
    </div>
  );
...
function Container108() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.7)] content-stretch flex flex-col h-[56.594px] items-start left-0 pb-px pt-[8px] px-[24px] top-0 w-[1129px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid inset-0 pointer-events-none" />
      <Container109 />
    </div>
  );
