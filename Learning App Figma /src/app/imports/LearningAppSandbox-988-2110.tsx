import svgPaths from "./svg-e3birm59uf";
...
function Container() {
  return (
    <div className="h-[199.497px] relative shrink-0 w-[547.778px]" data-name="Container">
...
function TestConfirmationModal() {
  return (
    <div className="absolute content-stretch flex h-[758.889px] items-center justify-center left-0 top-0 w-[1228.889px]" data-name="TestConfirmationModal" style={{ backgroundImage: "linear-gradient(148.303deg, rgb(240, 249, 255) 0%, rgb(224, 242, 254) 100%)" }}>
      <Container />
    </div>
  );
}
...
function Container5() {
  return (
    <div className="absolute content-stretch flex gap-[15.998px] h-[59.323px] items-start left-[40px] top-[685.2px] w-[590.885px]" data-name="Container">
      <Button1 />
      <Button2 />
    </div>
  );
...
function Heading2() {
  return (
    <div className="absolute h-[30px] left-[32px] top-[32px] w-[523.559px]" data-name="Heading 3">
...
function Container19() {
  return (
    <div className="absolute h-[115.99px] left-[32px] top-[85.99px] w-[523.559px]" data-name="Container">
      <Container9 />
      <Container12 />
      <Container15 />
      <Container18 />
...
function Container23() {
  return (
    <div className="absolute bg-[rgba(85,161,180,0.08)] content-stretch flex flex-col h-[74.583px] items-start left-[32px] pb-[0.556px] pt-[16.554px] px-[16.554px] rounded-[16px] top-[225.97px] w-[523.559px]" data-name="Container">
...
function Container25() {
  return (
    <div className="absolute h-[784.523px] left-0 top-0 w-[670.885px]" data-name="Container">
      <Container1 />
      <Container4 />
      <Container5 />
      <Container24 />
...
function Container26() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.98)] border-[0.556px] border-[rgba(255,255,255,0.5)] border-solid h-[785.634px] left-[278.45px] rounded-[32px] shadow-[0px_24px_64px_0px_rgba(0,0,0,0.2)] top-[-13.37px] w-[671.997px]" data-name="Container">
      <Container25 />
      <Button3 />
      <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_1px_0px_0px_rgba(255,255,255,0.9)]" />
    </div>
