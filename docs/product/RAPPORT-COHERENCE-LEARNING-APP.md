...
> 📎 **Études détaillées derrière ce rapport** : [`SOLUTIONS-00-SYNTHESE`](SOLUTIONS-00-SYNTHESE.md) (index) → le dossier [`SOLUTIONS-DETAIL`](SOLUTIONS-DETAIL.md) (un chapitre par incohérence). Ce document-ci est la **synthèse exécutive pour décision** ; les SOLUTIONS sont les **études de solutions** (options évaluées sous 6 lentilles). Les deux se complètent, ne se dupliquent pas.
