...
## 2. Pilier Learning App (SaaS — bêta ouverte)

Plateforme d'apprentissage Skills-Based. **Statut : bêta ouverte.**
...
- Le site affiche aujourd'hui un abonnement plat (Pass Solo 30 €/mois · Pass Pro 250 €/an).
- À réconcilier — **ne pas propager** l'un ou l'autre comme définitif.

**Offres hybrides (coaching + app)** *(Notion Catalogue, prix « à définir »)* : **Pack Mentorat** (individuel — 1h coaching + projet validant une compétence + Open Badge) · **Pack Accélération** (entreprise — 2×1h coaching stratégique + design d'un socle de compétences + Open Badge).

### Catalogue réel des parcours de l'app (Notion, au 2026-06-10)
...
## 3. Pilier Accompagnement & Conseil — méthode STRIDE

**STRIDE = méthode de conseil en 6 étapes** pour déployer l'IA en organisation :

**S**'orienter → **T**ester → **R**éaliser → **I**ntégrer → **D**éployer → **É**voluer

*(Réaliser vient AVANT Intégrer.)*

> **STRIDE a deux acceptions à ne pas fusionner (D3) :** la **méthode** ci-dessus (discours marketing) et le **type de projet** « STRIDE IA Deployment » dans la spec produit (CDC 11). Même concept, deux niveaux.

**Cible :** ETI de 200 à 2 000 salariés + organismes de formation (OF).

**Missions** ⏸️ *(prix provisoires, base CDC)* :
| Mission | Prix indicatif |
|---|---|
| Méthode STRIDE (accompagnement complet) | 10 000 € HT |
| Solutions IA « Plug & Play » | 7 500 € HT / projet |
| Upskilling L&D sur-mesure | 20 000 € HT / projet |

**Bonus :** **1 an d'abonnement Learning App offert** pour tout contrat STRIDE.

---

## 4. Pilier Prestations Expertes (TJM)

Monétisation de l'expertise au temps. TJM cible **1 000 € HT / jour**. *(Source : Notion « Catalogue d'Offres », maj 2026-06-09. ⏸️ prix gelés.)*

**Pôle Conception & Diagnostic** (lead Chloé) — le « labo » :
- Création de contenus « Power Skills » (micro-learning, scripts vidéo, ancrage mémoriel)
- **Audit Flash SBO (0,5–1 j)** : diagnostic express + analyse du « skills gap » → **porte d'entrée vers STRIDE**
- Ingénierie pédagogique (architecture de dispositifs, design de parcours, ingénierie de certification Open Badges)

**Pôle Delivery & Animation** (lead Pierre-Armand) — le « terrain » :
- Animation & coaching (prestataire C-Campus / partenaires)
- Conférences & masterclasses SBO (futur du travail, IA, transition SBO)
- Maintenance & support des outils IA installés

> **Flywheel** : l'expertise (Pilier 3) crée la confiance et révèle les skills gaps → le conseil STRIDE (Pilier 2) installe la méthode + les outils IA → la Learning App (Pilier 1) reste et génère du récurrent.

---

## 5. Chiffres — utilisables / interdits

**✅ Utilisables (toujours attribués à C-Campus, jamais présentés comme stats TLS) :**
- **578 personnes formées en 2023** par C-Campus sur le thème de la formation de formateur.
- **+93 % de satisfaction** aux formations de formateurs C-Campus.

**⏸️ Gelés / à sourcer avant tout usage :**
- Taille de marché (32 Md€ formation pro ? 1,7 Md€ EdTech ? — incohérent entre docs) → **ne pas utiliser** tant que non sourcé.
- « 800+ EdTech en France » → à sourcer.
- CA visé 260 700 € → chiffre interne, ⏸️.

**🚫 Règle absolue :** **aucune métrique TLS inventée** (satisfaction, adoption, complétion, turnover, NPS…). Si la donnée n'existe pas et n'est pas sourcée, on ne l'écrit pas.
