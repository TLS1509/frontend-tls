...
const CONTAINER_VARIANT: Record<TabsVariant, string> = {
  ...
  underline: 'inline-flex items-center gap-1 border-b border-ink-200',
  boxed:     'inline-flex items-stretch border border-ink-200 rounded-xl overflow-hidden bg-white',
};

const TAB_BASE =
  'inline-flex items-center gap-2 bg-transparent border-0 font-body text-body-sm font-medium text-ink-600 cursor-pointer transition-[color,background-color,box-shadow] duration-fast ease-emphasis ' +
