...
export const InlineWin: React.FC<InlineWinProps> = ({
  ...
  >
    <span
      aria-hidden="true"
      className="inline-flex items-center justify-center w-10 h-10 rounded-pill bg-gradient-to-br from-secondary-600 to-accent-700 text-white shrink-0 shadow-md"
    >
