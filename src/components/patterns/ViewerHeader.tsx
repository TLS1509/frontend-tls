      ...
      <div className="flex items-center gap-stack px-4 sm:px-6 lg:px-8 py-2">
        ...
        {onBack && (
          <button
            ...
            className={[
              'shrink-0 inline-flex items-center gap-stack-xs min-h-touch px-3 py-1.5 rounded-pill bg-ink-50 hover:bg-ink-100 text-ink-700 hover:text-ink-900 transition-colors text-caption font-bold',
              'focus-visible:outline-2 focus-visible:outline-offset-2',
              focusOutline,
            ].join(' ')}
          >
        ...
        {(title || eyebrow || subtitle) && (
          <div className="flex-1 min-w-0 flex flex-col items-start sm:items-center">
            ...
            {title && (
              <h1
                className="font-display text-h4 font-bold text-ink-900 leading-tight truncate w-full text-left sm:text-center"
