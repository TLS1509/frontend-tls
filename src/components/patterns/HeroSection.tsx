    ...
    >
      ...
      {showBackButton && (
        <button
          ...
          className={[
            'relative z-10 inline-flex items-center gap-stack-xs mb-stack-lg px-4 py-2 rounded-lg cursor-pointer transition-all duration-200 hover:-translate-x-0.5 text-caption font-bold border focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-current',
            isLight
