...
export const MotionSprintShowcase: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-ink-50 to-primary-50/30 py-16 px-4">
      {/* Header */}
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <section className="space-y-4">
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border border-ink-100">
            ...
            <p className="text-caption text-ink-500 mt-4 text-center">
        ...
        <section className="space-y-4">
          ...
          <div className="hover-glow-primary">
            <Card className="p-8 cursor-pointer transition-all duration-300">
      ...
      {/* Summary Section */}
      <div className="max-w-6xl mx-auto mt-20 p-8 bg-white rounded-lg border border-ink-100 shadow-sm">
        <h2 className="text-h3 font-bold text-ink-900 mb-4">📊 Sprint Summary</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <h3 className="text-h5 font-semibold text-primary-700 mb-2">SPRINT 1</h3>
          ...
          <div>
            <h3 className="text-h5 font-semibold text-secondary-700 mb-2">SPRINT 2</h3>
            <ul className="text-body-sm text-ink-600 space-y-1">
          ...
          <div>
            <h3 className="text-h5 font-semibold text-accent-700 mb-2">SPRINT 3</h3>
            <ul className="text-body-sm text-ink-600 space-y-1">
