        ...
        aside={
          <SectionCard title="Statut">
            <ul className="m-0 p-0 list-none flex flex-col gap-stack-xs text-caption text-success-fg">
              <li className="inline-flex items-center gap-stack-2xs"><CheckCircle2 size={14} /> Transmis au coach</li>
              <li className="inline-flex items-center gap-stack-2xs"><CheckCircle2 size={14} /> Pris en compte pour la session</li>
            </ul>
          </SectionCard>
        }
      />
