...
const MatchPanel: React.FC = () => (
  <div className="flex flex-col gap-stack-lg">
    <div className="flex items-center justify-between gap-stack">
      ...
      <span className="inline-flex items-center gap-1 font-body text-caption font-semibold text-accent-700 bg-accent-50 px-2.5 py-1 rounded-pill whitespace-nowrap">
    ...
    <div className="flex items-center gap-2 rounded-xl bg-accent-50 px-3 py-2.5">
