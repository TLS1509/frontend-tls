...
export const MarketingLayout: React.FC = () => (
  <MarketingToastProvider>
    <div className="min-h-[100dvh] flex flex-col bg-gradient-page-ambient">
      ...
      <a
        href="#contenu"
        className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-toast focus:inline-flex focus:h-11 focus:items-center focus:rounded-pill focus:bg-ink-900 focus:px-stack-md focus:font-body focus:text-body-sm focus:font-bold focus:text-white focus:outline-2 focus:outline-offset-2 focus:outline-accent-400"
      >
        Aller au contenu
      </a>
