  ...
  const renderResult = (item: ResultItem) => {
    ...
    return (
      <article
        ...
        className="group flex flex-col gap-stack p-stack-md rounded-lg border border-ink-100 bg-white hover:border-primary-300 hover:bg-primary-50/40 transition-colors duration-base cursor-pointer"
      >
    ...
    <div className="min-h-[100dvh] bg-surface">
      <PageShell>
        ...
        <SearchInput
          ...
          trailing={isSearching ? <Spinner size="sm" tone="muted" label="Recherche…" /> : undefined}
        />
