  ...
  const renderResult = (item: ResultItem) => {
    ...
    return (
      <article
        ...
        className="group flex flex-col gap-stack p-5 rounded-lg border border-ink-100 bg-white hover:border-primary-300 hover:bg-primary-50/40 transition-colors duration-base cursor-pointer"
      >
