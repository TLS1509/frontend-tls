            ...
            <div key={step.id} className="flex gap-stack items-start">
              ...
              <div className="flex-1 bg-white border border-ink-200 rounded-lg p-stack-lg">
                ...
                <textarea
                  ...
                  className="w-full h-auto py-stack px-stack rounded-lg border border-ink-200 bg-ink-50 text-ink-900 font-body text-body leading-[1.65] resize-y outline-none transition-colors duration-200 focus:border-primary-400 focus:bg-white placeholder:text-ink-500"
                />
              </div>
            </div>
          ))}
