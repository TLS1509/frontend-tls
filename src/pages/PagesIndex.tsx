...
const PAGES_LIST: PageItem[] = [
  ...
  { id: 'account', name: 'Account', description: 'Compte, sécurité et interface (ex-Settings fusionné, Phase 24)', path: '/account', icon: '🔐', status: 'completed', category: 'feature', design: 'settings', itemType: 'Account', family: 'account-auth' },
