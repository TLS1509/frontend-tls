...
export const MOCK_PARCOURS_DATA: Record<string, Parcours> = {
  ...
  '1': {
    ...
    description:
      'Apprends les principes essentiels du leadership moderne et développe tes compétences de management.',
    ...
    etapes: [
      {
        ...
        lecons: [
          { id: 'lecon-1-1-1', number: 1, title: 'Introduction au Leadership', description: 'Découvre les fondamentaux et les différents styles de leadership', duration: '45 min', completed: true },
          { id: 'lecon-1-1-2', number: 2, title: 'Présence et Authenticité', description: 'Développe ta présence authentique en tant que leader', duration: '1h', completed: true },
          { id: 'lecon-1-1-3', number: 3, title: 'Vision et Stratégie', description: 'Articule ta vision et crée une stratégie inspirante', duration: '1h 15min', completed: true },
        ],
      ...
      },
      {
        ...
        lecons: [
          { id: 'lecon-1-2-1', number: 1, title: 'Motivation et Engagement', description: 'Comprends les mécanismes de motivation et d\'engagement d\'une équipe performante.', duration: '50 min', completed: true },
          { id: 'lecon-1-2-2', number: 2, title: 'Communication Efficace', description: 'Maîtrise les techniques de communication de leader à fort impact.', duration: '1h', completed: false },
          { id: 'lecon-1-2-3', number: 3, title: 'Gestion des Conflits', description: 'Résous les conflits de manière constructive pour renforcer la cohésion.', duration: '55 min', completed: false },
        ],
      ...
      },
      {
        ...
        lecons: [
          { id: 'lecon-1-3-1', number: 1, title: 'Délégation et Autonomisation', description: 'Apprends à déléguer efficacement et à développer tes collaborateurs.', duration: '50 min', completed: false },
          { id: 'lecon-1-3-2', number: 2, title: 'Feedback et Développement', description: 'Donne un feedback constructif et facilite la croissance professionnelle.', duration: '1h 10min', completed: false },
          { id: 'lecon-1-3-3', number: 3, title: 'Culture et Valeurs', description: 'Crée une culture organisationnelle forte et alignée sur tes valeurs.', duration: '1h 15min', completed: false },
        ],
    ...
    finalProject: {
      ...
      description: 'Développe un plan d\'action concret pour appliquer tes apprentissages dans ton contexte professionnel.',
    ...
    complementaryContent: [
      ...
      { id: 'comp-1-3', title: 'Template : Plan de Vision', description: 'Un modèle pour créer ta déclaration de vision personnelle.', duration: '8 min', kind: 'template', tone: 'sun' },
      { id: 'comp-1-4', title: 'Podcast : Leaders Inspirants', description: 'Écoute des histoires de leaders qui ont transformé leurs organisations.', duration: '25 min', kind: 'podcast', tone: 'primary' },
      { id: 'comp-1-5', title: 'Exercice : Feedback 360', description: 'Un outil interactif pour recevoir du feedback de tes pairs.', duration: '20 min', kind: 'exercise', tone: 'warm' },
    ],
  ...
  '2': {
    ...
    description: 'Maîtrise les techniques de communication interpersonnelle pour améliorer tes relations professionnelles.',
    ...
    etapes: [
      {
        ...
        lecons: [
          ...
          { id: 'lecon-2-1-2', number: 2, title: 'Écoute Active', description: 'Développe l\'écoute active et empathique pour mieux comprendre tes interlocuteurs.', duration: '1h', completed: true },
        ],
      ...
      },
      {
        ...
        lecons: [
          { id: 'lecon-2-2-1', number: 1, title: 'Expression Claire', description: 'Exprime-toi avec clarté et impact dans tes interactions professionnelles.', duration: '1h', completed: true },
          { id: 'lecon-2-2-2', number: 2, title: 'Langage Non-Verbal', description: 'Maîtrise ton langage corporel pour renforcer tes messages.', duration: '50 min', completed: true },
          { id: 'lecon-2-2-3', number: 3, title: 'Communication Assertive', description: 'Affirme-toi sans agressivité dans toutes les situations professionnelles.', duration: '55 min', completed: true },
        ],
        progress: { completed: 3, total: 3, percentage: 100 },
      },
      {
        ...
        lecons: [
          { id: 'lecon-2-3-1', number: 1, title: 'Gestion des Objections', description: 'Réponds aux préoccupations de manière constructive et positive.', duration: '1h', completed: true },
          { id: 'lecon-2-3-2', number: 2, title: 'Feedback Constructif', description: 'Donne et reçois du feedback efficacement pour progresser ensemble.', duration: '55 min', completed: true },
          { id: 'lecon-2-3-3', number: 3, title: 'Synthèse et Pratique', description: 'Applique tes apprentissages dans des situations professionnelles réelles.', duration: '1h 15min', completed: true },
        ],
        progress: { completed: 3, total: 3, percentage: 100 },
      },
    ],
    finalProject: {
      ...
      description: 'Crée un plan d\'amélioration de communication pour une situation réelle de ton quotidien professionnel.',
      ctaText: 'Commencer le projet',
      locked: false,
    },
    complementaryContent: [
      ...
      { id: 'comp-2-3', title: 'Quiz : Styles de Communication', description: 'Teste tes connaissances sur les différents styles de communication.', duration: '10 min', kind: 'exercise', tone: 'sun' },
  ...
  '3': {
    ...
    description: 'Découvre les méthodologies agiles et apprends à piloter tes projets de manière flexible et efficace.',
    ...
    finalProject: { id: 'project-3', title: 'Projet Final : Sprint Complet', description: 'Planifie et simule un sprint complet en équipe virtuelle.', ctaText: 'Lancer le projet', locked: true },
    complementaryContent: [
      { id: 'comp-3-1', title: 'Guide : Scrum en pratique', description: 'Un guide complet pour implémenter Scrum dans ton équipe.', duration: '20 min', kind: 'guide', tone: 'warm' },
      { id: 'comp-3-2', title: 'Template : Tableau Kanban', description: 'Un template prêt à l\'emploi pour gérer ton backlog.', duration: '5 min', kind: 'template', tone: 'primary' },
    ],
  ...
  '4': {
    ...
    description: 'Développe ton intelligence émotionnelle pour mieux gérer le stress et les relations interpersonnelles.',
    ...
    finalProject: { id: 'project-4', title: 'Plan de Développement Émotionnel', description: 'Crée ton plan personnalisé de développement en IE.', ctaText: 'Démarrer le plan', locked: true },
    complementaryContent: [
  ...
  '5': {
    ...
    description: 'Apprends un cadre structuré pour prendre des décisions stratégiques complexes et assurer leur mise en œuvre.',
    ...
    finalProject: { id: 'project-5', title: 'Cas Pratique Stratégique', description: 'Analyse un cas réel et propose un plan de décision structuré.', ctaText: 'Accéder au cas', locked: true },
    complementaryContent: [
      ...
      { id: 'comp-5-2', title: 'Exercice : Simulation décisionnelle', description: 'Mets-toi dans la peau d\'un décideur stratégique.', duration: '30 min', kind: 'exercise', tone: 'warm' },
    ],
  ...
  '6': {
    ...
    description: 'Explore comment piloter la transformation digitale et créer une culture d\'innovation durable.',
    ...
    etapes: [
      {
        ...
        lecons: [
          ...
          { id: 'lecon-6-1-2', number: 2, title: 'Construire une feuille de route digitale', description: 'Méthode pour créer ta roadmap de transformation.', duration: '1h 15min', completed: true },
        ],
        progress: { completed: 2, total: 2, percentage: 100 },
      },
      {
    ...
    finalProject: { id: 'project-6', title: 'Plan de Transformation Digitale', description: 'Rédige un plan de transformation digitale pour ton organisation.', ctaText: 'Créer mon plan', locked: false },
    complementaryContent: [
      ...
      { id: 'comp-6-3', title: 'Template : Roadmap digitale', description: 'Modèle prêt à utiliser pour ta feuille de route.', duration: '10 min', kind: 'template', tone: 'sun' },
    ],
    ...
    etapes: [
      {
        ...
        completed: false,
        progression_mode: 'STRICT' as const,
        description: 'Maîtrise les tokens de design, l\'architecture Figma et la méthodologie Design System',
...
export const MOCK_PARCOURS_LIST: ParcoursListItem[] = [
  ...
  },
  {
    ...
    title: 'Communication Efficace',
    description:
      'Maîtrise les techniques de communication interpersonnelle pour améliorer tes relations professionnelles.',
    instructor: 'Jean Martin',
    level: 'intermédiaire',
    duration: '4 semaines',
    lessons: 8,
  ...
  },
  {
    ...
    title: 'Gestion de Projet Agile',
    description:
      'Découvre les méthodologies agiles et apprends à piloter tes projets de manière flexible et efficace.',
    instructor: 'Pierre Leclerc',
    level: 'intermédiaire',
    duration: '8 semaines',
    lessons: 16,
  ...
  },
  {
    ...
    title: 'Intelligence Émotionnelle en Entreprise',
    description:
      'Développe ton intelligence émotionnelle pour mieux gérer le stress et les relations interpersonnelles.',
    instructor: 'Sophie Bernard',
    level: 'avancé',
    duration: '6 semaines',
    lessons: 14,
  ...
  },
  {
    ...
    title: 'Prise de Décision Stratégique',
    description:
      'Apprends un cadre structuré pour prendre des décisions stratégiques complexes et assurer leur mise en œuvre.',
    instructor: 'Marc Rousseau',
    level: 'avancé',
    duration: '8 semaines',
    lessons: 18,
  ...
  },
  {
    ...
    title: 'Transformation Digitale et Innovation',
    description:
      "Explore comment piloter la transformation digitale et créer une culture d'innovation durable.",
    instructor: 'Isabelle Fontaine',
    level: 'avancé',
    duration: '10 semaines',
    lessons: 20,
