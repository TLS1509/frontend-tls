...
export const EDRA_R_QUESTIONS = [
  {
    id: 'experience',
    title: 'Expérience',
    description: 'Décris brièvement la situation ou l\'événement vécu',
    placeholder: 'Quelle situation as-tu vécue ?',
  },
  {
    id: 'description',
    title: 'Description',
    description: 'Que s\'est-il passé exactement ? Faits et observations',
    placeholder: 'Décris les faits objectivement...',
  },
  {
    id: 'reflexion',
    title: 'Réflexion',
    description: 'Quels enseignements en tires-tu ? Émotions, prises de conscience',
    placeholder: 'Qu\'as-tu ressenti et compris ?',
  },
  {
    id: 'action',
    title: 'Action',
    description: 'Que feras-tu différemment la prochaine fois ?',
    placeholder: 'Décris ton plan d\'action concret...',
  },
  {
    id: 'resultat',
    title: 'Résultat attendu',
    description: 'Quel impact espères-tu obtenir ?',
    placeholder: 'Quel résultat vises-tu ?',
  },
] as const;
...
export const GENERIC_STRUCTURED_QUESTIONS = [
  {
    id: 'learning',
    title: 'Qu\'as-tu appris ?',
    description: 'Identifie les insights clés, concepts ou compétences développées',
    placeholder: 'Note les apprentissages principaux...',
  },
  {
    id: 'challenges',
    title: 'Quels défis as-tu rencontrés ?',
    description: 'Décris les obstacles, difficultés ou points de blocage',
    placeholder: 'Parle des défis rencontrés...',
  },
  {
    id: 'application',
    title: 'Comment vas-tu appliquer cela ?',
    description: 'Planifie les actions concrètes et les changements à mettre en œuvre',
